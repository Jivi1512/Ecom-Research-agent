...
export const MOCK_CATALOG = [
  ...
  { sku: 'SKU-4455', title: 'GlacierCool Smart Water Bottle', category: 'Accessories', brand: 'GlacierTech', list_price: 45.00, currency: 'USD' }
];
...
export const MOCK_REVIEWS = [
  ...
  { sku: 'SKU-4455', review_id: 'R6', date: '2023-11-02', rating: 3, text: 'Connection is flaky, but it keeps water cold.', source_url: 'https://amazon.com/review/6' },
  { sku: 'SKU-4455', review_id: 'R7', date: '2023-11-05', rating: 5, text: 'Love the hydration reminders.', source_url: 'https://amazon.com/review/7' }
];
...
export const MOCK_RATES = { 'USD': 1.0, 'EUR': 1.08, 'GBP': 1.25 };
